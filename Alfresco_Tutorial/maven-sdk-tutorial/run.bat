...
:build_acs
	...
	call %MVN_EXEC% clean package -pl maven-sdk-tutorial-platform,maven-sdk-tutorial-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl maven-sdk-tutorial-platform,maven-sdk-tutorial-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl maven-sdk-tutorial-platform
EXIT /B 0
:purge
