...
:build_acs
	...
	call %MVN_EXEC% clean package -pl actions-tutorial-platform,actions-tutorial-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl actions-tutorial-platform,actions-tutorial-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl actions-tutorial-platform
EXIT /B 0
:purge
