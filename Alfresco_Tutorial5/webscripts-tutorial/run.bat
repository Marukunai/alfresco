...
:build_acs
	...
	call %MVN_EXEC% clean package -pl webscripts-tutorial-platform,webscripts-tutorial-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl webscripts-tutorial-platform,webscripts-tutorial-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl webscripts-tutorial-platform
EXIT /B 0
:purge
