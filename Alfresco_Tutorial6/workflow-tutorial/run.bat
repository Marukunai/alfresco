...
:build_acs
	...
	call %MVN_EXEC% clean package -pl workflow-tutorial-platform,workflow-tutorial-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl workflow-tutorial-platform,workflow-tutorial-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl workflow-tutorial-platform
EXIT /B 0
:purge
